          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  {...field('category')}
                  className="w-full appearance-none bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-sm text-white
                             focus:outline-none focus:ring-1 focus:ring-brand-red focus:border-brand-red pr-8"
                >
                  {CATEGORIES.map((c) => (
