...
## Corpus Check
- 124 files · ~1,778,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 728 nodes · 1201 edges · 87 communities (42 shown, 45 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34b7a7c0`
...
Cohesion: 0.18
Nodes (19): BADGE_STYLES, CARD_GRADIENT, Cart, cartCount(), CartDrawer(), CartEntry, cartTotal(), CATEGORIES (+11 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (48): AccountPage(), fmtDate(), OfferCard(), Order, OrderCard(), OrderItem, Profile, PromoCode (+40 more)
...
Cohesion: 0.05
Nodes (39): AdminSidebar(), ALL_NAV, PermissionsContext, PermissionsContextType, usePermissions(), Category, CategoryForm, EMPTY_FORM (+31 more)
...
Cohesion: 0.13
Nodes (14): AboutPage(), oswald, STATS, VALUES, oswald, POPULAR, REASONS, EMPTY (+6 more)
...
## Knowledge Gaps
- **178 isolated node(s):** `eslintConfig`, `config`, `nextConfig`, `name`, `version` (+173 more)
...
- **Why does `Extra` connect `Community 1` to `Community 0`, `Community 53`?**
