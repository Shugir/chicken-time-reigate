...
## Corpus Check
- 111 files · ~1,088,925 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 683 nodes · 1126 edges · 67 communities (38 shown, 29 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cbff06c`
...
Cohesion: 0.05
Nodes (58): AdminSidebar(), ALL_NAV, PermissionsContext, PermissionsContextType, usePermissions(), AnalyticsData, AnalyticsPage(), CHART_THEME (+50 more)
...
Cohesion: 0.13
Nodes (15): DeleteConfirm(), DeliveryPage(), DeliveryZone, NAV, SaveState, ZoneModal(), DeleteConfirm(), NAV (+7 more)
...
Cohesion: 0.17
Nodes (12): Category, CategoryForm, EMPTY_FORM, Aggregates, Driver, DriverForm, DriversPage(), EMPTY_FORM (+4 more)
...
- **Why does `Supabase Admin Client` connect `Community 60` to `Community 61`, `Community 11`, `Community 3`, `Community 53`?**
