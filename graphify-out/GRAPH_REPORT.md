...
## Corpus Check
- 115 files · ~1,089,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 694 nodes · 1135 edges · 70 communities (39 shown, 31 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18ca8143`
...
Cohesion: 0.07
Nodes (30): AdminSidebar(), ALL_NAV, Category, CategoryForm, EMPTY_FORM, DeleteConfirm(), DeliveryPage(), DeliveryZone (+22 more)
...
## Knowledge Gaps
- **177 isolated node(s):** `eslintConfig`, `config`, `nextConfig`, `name`, `version` (+172 more)
...
- **Why does `Supabase Admin Client` connect `Community 67` to `Community 11`, `Community 65`, `Community 3`, `Community 61`?**
