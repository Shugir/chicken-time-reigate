...
## Knowledge Gaps
- **175 isolated node(s):** `supabase`, `supabase`, `eslintConfig`, `config`, `nextConfig` (+170 more)
...
- **What connects `supabase`, `supabase`, `eslintConfig` to the rest of the system?**
