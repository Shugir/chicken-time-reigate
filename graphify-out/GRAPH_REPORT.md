...
## Corpus Check
- 177 files · ~1,819,861 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1147 nodes · 1908 edges · 117 communities (68 shown, 49 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4a071b8a`
...
Cohesion: 0.19
Nodes (9): AdminDataTable(), Column, Props, AdjustForm, UserBalance, AdjustForm, AuthUser, Driver (+1 more)
...
Cohesion: 0.06
Nodes (68): PermissionsContext, PermissionsContextType, usePermissions(), CustomerReceipt(), ReceiptItem, ReceiptOrder, BoardData, CustomerReceipt() (+60 more)
...
Cohesion: 0.08
Nodes (10): GET(), GET(), GET(), GET(), POST(), supabaseAdmin, GET(), GET() (+2 more)
...
Cohesion: 0.22
Nodes (4): AdminSidebar(), ALL_NAV, NAV_GROUPS, ComboDiscount
...
Cohesion: 0.43
Nodes (6): FilterConfig, ALL_PERMISSIONS, EMPTY_FORM, StaffForm, StaffMember, StaffPage()
...
## Knowledge Gaps
- **357 isolated node(s):** `supabase`, `OrderItem`, `DispatchOrder`, `DispatchDriver`, `BoardData` (+352 more)
...
- **What is the exact relationship between `Supabase Admin Client` and `Sign In Page`?**
  _Edge tagged AMBIGUOUS (relation: shares_data_with) - confidence is low._
- **Why does `AdminReceiptOrder` connect `Community 75` to `Community 0`, `Community 113`, `Community 1`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `supabaseAdmin` connect `Community 84` to `Community 0`, `Community 97`, `Community 3`, `Community 100`, `Community 70`, `Community 73`, `Community 107`, `Community 12`, `Community 111`, `Community 80`, `Community 113`, `Community 114`, `Community 116`, `Community 89`, `Community 93`, `Community 94`?**
