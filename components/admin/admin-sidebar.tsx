...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 bg-zinc-950 border-r border-zinc-800/60 flex flex-col sticky top-0 self-start h-screen overflow-y-auto">
      {/* Brand */}
                ...
                {visible.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.label}
                      {active && (
                        <span className="ml-auto w-1.5 h-1.5 rounded-full bg-brand-red shrink-0" />
                      )}
                    </Link>
                  )
                })}
